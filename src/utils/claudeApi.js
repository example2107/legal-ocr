...
- Неоднозначные слова с маленькой буквы рядом с инициалами: некоторые фамилии совпадают с обычными словами русского языка и могут быть написаны с маленькой буквы из-за OCR-ошибки. Например, «боковой» — это и прилагательное («боковой удар»), и фамилия «Бокова» в родительном падеже. КЛЮЧЕВОЕ ПРАВИЛО: если рядом со спорным словом стоят инициалы в формате «Х.Х.» или «Х.» — это ВСЕГДА фамилия, а не обычное слово, вне зависимости от регистра. Примеры: «боковой В.Р.» → фамилия Бокова; «новой А.С.» → фамилия Новая или похожая; «левой Т.П.» → фамилия. Добавляй такие варианты в mentions[]: «боковой», «боковой В.Р.»
