...
- Любые фрагменты, похожие на персональные данные или реквизиты: адреса, улицы, населенные пункты, номера документов, телефоны, email, даты рождения, номера карт, ИНН, СНИЛС, VIN, госномера
...
ЖЕСТКОЕ ПРАВИЛО:
- Никогда не исправляй и не подменяй ФИО, адреса, названия улиц, населенных пунктов, реквизиты документов и другие ПД-фрагменты, даже если они кажутся редкими или странными.
- Если фрагмент похож на ПД, но ты не уверен в нем, оставь его как есть. Не предлагай для него нормализацию.
