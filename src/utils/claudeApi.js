...
2. СЕМАНТИЧЕСКАЯ НЕСОВМЕСТИМОСТЬ — слово существует, но абсурдно в данном контексте:
   - "судья подписал лошадь" → "лошадь" семантически невозможна здесь
...
3. НАРУШЕНИЕ ЮРИДИЧЕСКОГО ШАБЛОНА — в типовой фразе стоит неподходящее слово:
   ...
   - "гражданка Иванова проживает по адресу: небо" → явно OCR-мусор

4. СЛОВО-ПРИЗРАК — слово существует, но явно является OCR-артефактом (нетипичные сочетания в контексте):
   - "в интересах субъект дочери" → "субъект" здесь — артефакт вместо "своей"
   - "похитить с банковской карты АО Альфа банк, оформленный музей имя" → "музей" вместо "на"
   - "период времени с 24.12.2025 годла по" → "годла" — явный артефакт

ПРИМЕРЫ ПРАВИЛЬНОЙ РАБОТЫ:
✓ "в интересах субъект дочери Боковой" → suspicious: "субъект" (нарушение согласования + артефакт)
✓ "с 24.12.2025 годла по 09.02.2026" → suspicious: "годла" (не существует)
✓ "рассмотрев материалы проверки сообщения поступило преступлении" → suspicious: "поступило" (грамматика)
✗ "заявление о возбуждении уголовного дела" → всё правильно, не помечать
✗ "гражданка Корчагова Е.В." → имя собственное, не помечать
✗ "руководствуясь ст. 24, 144, 145, 148 УПК РФ" → юридический термин, не помечать

НЕ ПОМЕЧАЙ:
- Имена, фамилии, отчества
- Аббревиатуры (УПК, МВД, ОП, КУСП и т.д.)
- Номера статей, дат, сумм
- Слова которые грамматически и семантически уместны
