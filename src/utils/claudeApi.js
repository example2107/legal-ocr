...
2. Используй markdown разметку:
   - Главное название документа (ПОСТАНОВЛЕНИЕ, РЕШЕНИЕ, ОПРЕДЕЛЕНИЕ и т.д.) стоящее по центру: ## НАЗВАНИЕ
   - Подзаголовок под названием (например "об отказе в возбуждении уголовного дела"): [CENTER]текст[/CENTER]
   - Важные разделы (ПОСТАНОВИЛ, УСТАНОВИЛ, РЕШИЛ и т.д.): **ТЕКСТ**
3. Для строк где текст одновременно в РАЗНЫХ КОНЦАХ строки — город слева и дата справа: [LEFTRIGHT: левый | правый]
   ВАЖНО: НЕ используй [LEFTRIGHT] для подписей, должностей и ФИО — они всегда идут обычным текстом слева
4. Для любых других строк расположенных по центру: [CENTER]текст[/CENTER]
