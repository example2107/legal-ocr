...
- В mentions[] пиши фамилию ТОЛЬКО в именительном падеже (кто? что?) — система сама найдёт все падежные формы. Например: если в тексте «Завгородней» — в mentions[] пиши «Завгородняя»
...
- OCR-артефакт «г р.»: в юридических документах часто встречается сокращение «гр.» (гражданин/гражданка), которое OCR иногда разбивает на «г р.» или «г. р.». Если в тексте встречается «г р. Иванов» или «г. р. Иванова» — это «гр. Иванов/Иванова». Буква «г» или «г.» перед «р.» является частью этого артефакта и НЕ является частью имени. В mentions[] включай вариант БЕЗ этого префикса (только фамилию и инициалы). Пример: «г р. Корчаговой Е.В.» → fullName: «Корчагова Е.В.», mentions: [«Корчагова», «Корчагова Е.В.», «г р. Корчагова», «г. р. Корчагова»] — ОБЯЗАТЕЛЬНО добавляй варианты с префиксом «г р.» и «г. р.» в mentions[] чтобы система обезличила весь фрагмент включая артефактный символ «г»
